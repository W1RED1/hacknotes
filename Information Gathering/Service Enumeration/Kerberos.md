...
## Useful tools
  ...
  *  [`seclists`](https://github.com/danielmiessler/SecLists/tree/master/Usernames/Names) and [`statistically-likely-usernames`](https://github.com/insidetrust/statistically-likely-usernames) for username discovery wordlists
...
## Enumerating users
  ...
  *  `seclists` and `statistically-likely-usernames` for user discovery wordlists
